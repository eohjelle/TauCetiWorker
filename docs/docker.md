...
The Compose deployment packages TauCetiWorker, Elan, GitHub CLI, Codex, Claude
Code, and the checksum-pinned Kiro CLI for an unattended Linux host. The Lean toolchain selected by TauCeti is downloaded
