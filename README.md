...
- The agents run with broad permissions on your machine and push to GitHub as
  ...
  GitHub token) is [issue #1](https://github.com/kim-em/TauCetiWorker/issues/1).
...
Planned next: [#1 sandbox the agents](https://github.com/kim-em/TauCetiWorker/issues/1)
and [#2 a third (DeepSeek via OpenRouter+Pi) reviewer-author](https://github.com/kim-em/TauCetiWorker/issues/2).
