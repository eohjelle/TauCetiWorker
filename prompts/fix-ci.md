...
gate. A green targeted build alone is NOT enough — the changed-module audits must pass too. CI remains
the authoritative repository-wide build, axiom, lint, and module-system audit.
