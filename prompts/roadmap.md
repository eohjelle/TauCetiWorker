You are authoring a new pull request to TauCetiProject/TauCeti, an AIs-welcome Lean 4 library downstream of Mathlib. You are in a clean checkout of `main`. Pick the cheapest genuine step your roadmap's milestones still NEED (the easiest target ON the critical path, not the easiest target anywhere) and write the best small, complete, sorry-free PR you can — optimised to pass the project's review rubrics. Do honest mathematics. Work autonomously to completion.
